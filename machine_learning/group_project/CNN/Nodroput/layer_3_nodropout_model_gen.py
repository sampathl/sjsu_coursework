...
test_file = 'test.csv'
model_file = 'layer_3_nodropout_model.json'
model_weights_file = 'layer_3_nodropout_model.hdf5'
...
model = Sequential()
model.add(Conv2D(filters=16, kernel_size=3, padding='same', activation='relu', input_shape=(image_size, image_size, 1)))model.add(MaxPooling2D(pool_size=2))
